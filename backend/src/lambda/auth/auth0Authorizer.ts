...
const jwksUrl = 'https://dev-2h1quykd.us.auth0.com/.well-known/jwks.json'
...
const getSigningKey = async (jwkurl, kid) => {
  ...
  if(!signingKey){
    console.error("No signing keys found")
    throw new Error('Invalid signing keys')
  }

  console.log("Signing keys created successfully ", signingKey)
  return signingKey
